...
return [
    ...
    */
    'services' => [
        'fixer' => ['access_key' => env('FIXER_ASSESS_KEY'), 'enterprise' => false],
        'currency_layer' => ['access_key' => env('CURRENCY_LAYER_ASSESS_KEY'), 'enterprise' => false],
        'exchange_rates_api' => ['access_key' => env('EXCHANGE_RATES_API_ASSESS_KEY')],
        'abstract_api' => ['api_key' => env('ABSTRACT_API_ASSESS_KEY')],
    ],
