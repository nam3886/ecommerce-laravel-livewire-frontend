<div>
    <x-partials.breadcrumb :title="__('about us')" />
            ...
            <div class="row d-flex align-items-center justify-content-between d-sm-column">
                ...
                <div class="col-md-6">
                    <div class="content" data-aos="fade-up" data-aos-delay="200">
                        <h3 class="title">ABOUT OUR SKINEST STORE</h3>
                                ...
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="company-logo-single-item swiper-slide">
                                        <div class="image"><img class="img-fluid"
                                                src="{{ asset('images/company-logo/company-logo-1.png') }}" alt="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="company-logo-single-item swiper-slide">
                                        <div class="image"><img class="img-fluid"
                                                src="{{ asset('images/company-logo/company-logo-2.png') }}" alt="">
                                        </div>
                                    </div>
                                    {{-- End Company Logo Single Item --}}
                                    {{-- Start Company Logo Single Item --}}
                                    <div class="company-logo-single-item swiper-slide">
                                        <div class="image"><img class="img-fluid"
                                                src="{{ asset('images/company-logo/company-logo-3.png') }}" alt="">
                                        </div>
                                    </div>
                                    {{-- End Company Logo Single Item --}}
                                    {{-- Start Company Logo Single Item --}}
                                    <div class="company-logo-single-item swiper-slide">
                                        <div class="image"><img class="img-fluid"
                                                src="{{ asset('images/company-logo/company-logo-4.png') }}" alt="">
                                        </div>
                                    </div>
                                    {{-- End Company Logo Single Item --}}
                                    {{-- Start Company Logo Single Item --}}
                                    <div class="company-logo-single-item swiper-slide">
                                        <div class="image"><img class="img-fluid"
                                                src="{{ asset('images/company-logo/company-logo-5.png') }}" alt="">
                                        </div>
                                    </div>
                                    {{-- End Company Logo Single Item --}}
                                    {{-- Start Company Logo Single Item --}}
                                    <div class="company-logo-single-item swiper-slide">
                                        <div class="image"><img class="img-fluid"
                                                src="{{ asset('images/company-logo/company-logo-6.png') }}" alt="">
                                        </div>
                                    </div>
                                    {{-- End Company Logo Single Item --}}
                                    {{-- Start Company Logo Single Item --}}
                                    <div class="company-logo-single-item swiper-slide">
                                        <div class="image"><img class="img-fluid"
                                                src="{{ asset('images/company-logo/company-logo-7.png') }}" alt="">
                                        </div>
                                    </div>
                                    {{-- End Company Logo Single Item --}}
                                    {{-- Start Company Logo Single Item --}}
                                    <div class="company-logo-single-item swiper-slide">
                                        <div class="image"><img class="img-fluid"
                                                src="{{ asset('images/company-logo/company-logo-8.png') }}" alt="">
                                        </div>
                                    </div>
                                    {{-- End Company Logo Single Item --}}
                                </div>
